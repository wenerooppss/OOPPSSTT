...
void Screen1ViewBase::handleKeyEvent(uint8_t key)
{
    ...
    {
        //Interaction1
        //When hardware button 3 clicked change screen to ScreenCCT
        //Go to ScreenCCT with no screen transition
        application().gotoScreenCCTScreenNoTransition();
